...
namespace Formulario_Principal_Car_EFULL.Formularios
{
    ...
    {
        // ===== 1) CAMPOS =====
        // Navegación por catálogos (IDs)
        private int? _tipoIdSel, _marcaIdSel, _modeloIdSel;

        // Edición (igual patrón que Propietarios)
        ...
        private Guna.UI2.WinForms.Guna2Button btn_Eliminar_Vehiculo;
        private Guna.UI2.WinForms.Guna2Button btn_Editar_Vehiculo;

        // Control de eventos durante binding
        ...
        private void FormVehiculo_Load(object sender, EventArgs e)
        {
            ...
            // Eventos (si no están cableados en diseñador)
        ...
        private void SetInitialState()
        {
            ...
            // Mantener items de Tipo ya cargados
            ...
            // Botones a modo "nuevo"
            _vehicleId = null;
            btn_Guardar_Vehiculo.Text = "Guardar";
            btn_Eliminar_Vehiculo.Enabled = true;
        ...
        private int? GetTipoIdByNombre(string nombre)
        {
            ...
            using (var cn = Conexion_SQL.OpenConnection())
            using (var cmd = new SqlCommand("SELECT TipoID FROM dbo.TipoVehiculo WHERE Nombre=@n", cn))
            {
        ...
        private int? GetMarcaIdByNombre(string nombre, int tipoId)
        {
            if (string.IsNullOrWhiteSpace(nombre)) return null;
            using (var cn = Conexion_SQL.OpenConnection())
            using (var cmd = new SqlCommand("SELECT MarcaID FROM dbo.MarcaVehiculo WHERE Nombre=@n AND TipoID=@t", cn))
            {
                cmd.Parameters.AddWithValue("@n", nombre.Trim());
        ...
        private int? GetModeloIdByNombre(string nombre, int marcaId)
        {
            if (string.IsNullOrWhiteSpace(nombre)) return null;
            using (var cn = Conexion_SQL.OpenConnection())
            using (var cmd = new SqlCommand("SELECT ModeloID FROM dbo.ModeloVehiculo WHERE Nombre=@n AND MarcaID=@m", cn))
            {
                cmd.Parameters.AddWithValue("@n", nombre.Trim());
        ...
        {
            using (var cn = Conexion_SQL.OpenConnection())
            using (var cmd = new SqlCommand("SELECT ModeloAnioID FROM dbo.ModeloAnio WHERE Anio=@a AND ModeloID=@mo", cn))
            {
        ...
        {
            // Evita que en modo edición se limpien combos por este evento
        ...
        private void btn_Guardar_Vehiculo_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                { MessageBox.Show("Kilometraje inválido."); return; }
                ...
                using (var cn = Conexion_SQL.OpenConnection())
                {
                    ...
                    if (!IsEditMode)
                    {
                        // INSERT con validación de placa única
        ...
        private void btn_Editar_Vehiculo_Click(object sender, EventArgs e)
        {
            ...
            {
                sel.VehiculoSeleccionado += (v) =>
                {
                    ConfigurarComoEdicion(v.VehicleID);
                };
                sel.ShowDialog(this);
            }
        }
        ...
        public void ConfigurarComoEdicion(int vehicleId)
        {
            ...
            btn_Eliminar_Vehiculo.Enabled = false;
            btn_Editar_Vehiculo.Enabled = false;

            CargarVehiculo(vehicleId);

            // Solo bloqueamos la placa
            txt_Placa.ReadOnly = true;
            txt_Placa.Enabled = false;
        }
        // Crea SIEMPRE una conexión NUEVA y CERRADA (no reutiliza el factory)
        private SqlConnection NuevaConexion()
        {
            // Usa tu cadena real:
            // Si ya la tienes en app.config, puedes leerla con ConfigurationManager.
            var cs = "Server=DESKTOP-9TRMID2;Database=CAR_EFULL;Integrated Security=True;TrustServerCertificate=True;";
            return new SqlConnection(cs); // cerrada
        }
        ...
        private void CargarVehiculo(int id)
        {
            ...
            LEFT JOIN dbo.Propietarios AS P
                ON P.ID_Propietario = V.ID_Propietario
            WHERE V.VehicleID = @id;", cn))
                {
                    cmd.Parameters.AddWithValue("@id", id);

                    cn.Open(); // la abrimos nosotros; es NUEVA, así que no hay conflicto
                    using (var rd = cmd.ExecuteReader(CommandBehavior.CloseConnection))
                    {
                        ...
                        idPropietarioSeleccionado = rd["ID_PropietarioVehiculo"] == DBNull.Value
                            ? 0
        ...
        private void InitializeComponent()
        {
            ...
            this.btn_Eliminar_Vehiculo = new Guna.UI2.WinForms.Guna2Button();
            ...
            this.guna2ShadowPanel1.Controls.Add(this.btn_Eliminar_Vehiculo);
            ...
            this.btn_Guardar_Vehiculo.Location = new System.Drawing.Point(680, 573);
            ...
            // 
            this.btn_Eliminar_Vehiculo.Animated = true;
            this.btn_Eliminar_Vehiculo.BorderRadius = 8;
            this.btn_Eliminar_Vehiculo.DisabledState.BorderColor = System.Drawing.Color.DarkGray;
            this.btn_Eliminar_Vehiculo.DisabledState.CustomBorderColor = System.Drawing.Color.DarkGray;
            this.btn_Eliminar_Vehiculo.DisabledState.FillColor = System.Drawing.Color.FromArgb(((int)(((byte)(169)))), ((int)(((byte)(169)))), ((int)(((byte)(169)))));
            this.btn_Eliminar_Vehiculo.DisabledState.ForeColor = System.Drawing.Color.FromArgb(((int)(((byte)(141)))), ((int)(((byte)(141)))), ((int)(((byte)(141)))));
            this.btn_Eliminar_Vehiculo.FillColor = System.Drawing.Color.FromArgb(((int)(((byte)(235)))), ((int)(((byte)(52)))), ((int)(((byte)(70)))));
            this.btn_Eliminar_Vehiculo.Font = new System.Drawing.Font("Montserrat SemiBold", 12F, System.Drawing.FontStyle.Bold);
            this.btn_Eliminar_Vehiculo.ForeColor = System.Drawing.Color.White;
            this.btn_Eliminar_Vehiculo.Image = global::Union_Formularios.Properties.Resources.icon_trash;
            this.btn_Eliminar_Vehiculo.ImageAlign = System.Windows.Forms.HorizontalAlignment.Left;
            this.btn_Eliminar_Vehiculo.ImageOffset = new System.Drawing.Point(5, -2);
            this.btn_Eliminar_Vehiculo.ImageSize = new System.Drawing.Size(25, 25);
            this.btn_Eliminar_Vehiculo.Location = new System.Drawing.Point(255, 573);
            this.btn_Eliminar_Vehiculo.Name = "btn_Eliminar_Vehiculo";
            this.btn_Eliminar_Vehiculo.ShadowDecoration.BorderRadius = 14;
            this.btn_Eliminar_Vehiculo.Size = new System.Drawing.Size(180, 45);
            this.btn_Eliminar_Vehiculo.TabIndex = 74;
            this.btn_Eliminar_Vehiculo.Text = "Eliminar";
            // 
            // btn_Editar_Vehiculo
            // 
            ...
            this.btn_Editar_Vehiculo.Location = new System.Drawing.Point(468, 573);
